	...
	return knex('forumPosts')
		...
		.then(function() {
			...
			return knex('forumPosts').insert([
				{
					...
					image_path:
            'https://static.makeuseof.com/wp-content/uploads/2016/07/cleaner-better-code-670x335.jpg'
				},
				{
					id: 2,
					user_id: 2,
            ...
            'https://cdn-images-1.medium.com/max/881/1*SKIAmwDYVnrMvFOopOCwPQ.png'
				...
				// 	image_path:
				//     'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTKpmZ-aMAPwH_Ao0Tj-b396UNFrhZ_NdBEH6pCU0mKB0-MKOj9gQ'
				// },
				// {
				// 	id: 9,
				// 	user_id: 7,
